...
Nel reengineering i processi possono essere completamente riprogettati e reiomplementati, quindi verso una discontinuità organizzativa della impresa.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth,
                    trim=20 120 10 100, % L B R T
                    clip]
                    {images/Lez02_p03_fig_04}
%   \caption{Sommario}
%   \label{fig:Lez15_p06_fig_02}
\end{figure}
\FloatBarrier
...
Gartner è una multinazionale di consulenza tecnologica, ricerca e analisi nell'ambito delle tecnologie, dell'informazione, della comunicazione e della collaborazione fondata nel 1979 e ha proposto questa definizione che è adesso abbastanza adottata. 

\FloatBarrier
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth,
                    trim=20 80 10 60, % L B R T
                    clip]
                    {images/Lez02_p03_fig_05}
%   \caption{Sommario}
%   \label{fig:Lez15_p06_fig_02}
\end{figure}
\FloatBarrier
...
Business process management è una disciplina di gestione dei processi.
...
Ultimo punto, devono essere rispettati dei protocolli.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth,
                    trim=20 120 10 80, % L B R T
                    clip]
                    {images/Lez02_p04_fig_03}
%   \caption{Sommario}
%   \label{fig:Lez15_p06_fig_02}
\end{figure}
\FloatBarrier
...
Business process management è sostenuto dai sistemi di gestione dei workflow, ma viene in qualche modo a sovrapporvisi, proprio per questa carenza di funzionalità nella gestione degli errori della messaggistica.
...
\section{Prospettive dei processi lavorativi}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth,
                    trim=20 90 10 60, % L B R T
                    clip]
                    {images/Lez02_p05_fig_01}
%   \caption{Sommario}
%   \label{fig:Lez15_p06_fig_02}
\end{figure}
\FloatBarrier
...
Quindi pone l'accento sulla assegnazione dei ruoli e le rispettive responsabilità, i diritti di accesso o di svolgimento delle attività, i livelli di autorità, diciamo, nell'ambito dell'organizzazione.
...
I dati che vengono acquisiti ed elaborati a questo livello, riguardano quindi l'intero mercato.
Non sono più dati esclusivamente interni allo svolgimento dell'azienda ma devono essere confrontate le situazioni ambientali e di altre organizzazioni per un confronto.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth,
                    trim=20 90 10 50, % L B R T
                    clip]
                    {images/Lez02_p05_fig_02}
%   \caption{Sommario}
%   \label{fig:Lez15_p06_fig_02}
\end{figure}
\FloatBarrier
...
Definitela, descrivetela e andate a individuare i vari processi decisionali.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth,
                    trim=20 40 10 50, % L B R T
                    clip]
                    {images/Lez02_p05_fig_05}
%   \caption{Sommario}
%   \label{fig:Lez15_p06_fig_02}
\end{figure}
\FloatBarrier
...
A questo livello quindi fanno parte i sistemi per la gestione delle basi di dati, fogli elettronici, i sistemi per la composizione, per l'editing basilare.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth,
                    trim=20 80 10 50, % L B R T
                    clip]
                    {images/Lez02_p05_fig_06}
%   \caption{Sommario}
%   \label{fig:Lez15_p06_fig_02}
\end{figure}
\FloatBarrier
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.50\textwidth,
                    trim=20 60 10 60, % L B R T
                    clip]
                    {images/Lez02_p06_fig_02}
%   \caption{Sommario}
%   \label{fig:Lez15_p06_fig_02}
\end{figure}
\FloatBarrier
...
Negli anni 70-80 noi abbiamo assistito al seguito di un approccio data driven.
...
Cominciano a essere sviluppati sistemi di office automation, possiamo ricordare per esempio la nascita della metafora della scrivania piuttosto che applicativi quali office o in seguito open office.
